...
return [
    'modules' => [
        ...
        'Petrichor_Business' => 1,
        'Petrichor_BusinessRegistration' => 0,
        'Petrichor_Charity' => 1,
        'Petrichor_Customization' => 1,
        'Petrichor_Redirect' => 1,
        'PointsforPurpose_CharitySelect' => 1,
        'PointsforPurpose_CharitySuggestion' => 1,
        'PointsforPurpose_PointAddCsv' => 1,
        'PointsforPurpose_RedeemVoucher' => 1,
        'PointsforPurpose_Rewards' => 1,
        'Privacy_Policy' => 1,
        'Temando_ShippingRemover' => 1,
        'Tla_CharitySuggestion' => 1,
        'Vertex_Tax' => 1,
